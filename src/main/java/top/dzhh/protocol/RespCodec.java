...
public class RespCodec {
    ...
    static {
        DECODERS.put(RespType.SIMPLE_STRING, new RespSimpleString(null));
        DECODERS.put(RespType.ERROR, new RespError(null));
        DECODERS.put(RespType.INTEGER, new RespInteger(null));
        DECODERS.put(RespType.BULK_STRING, new RespBulkString(null));
        DECODERS.put(RespType.RESP_ARRAY, new RespArray(null));
    }
    ...
    public static void main(String[] args) {
        ...
        buffer.writeBytes(RespConstants.CRLF);
        Resp decode = RespCodec.decode(buffer);
